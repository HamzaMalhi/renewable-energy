...
def read_windSolar_data():
    

    # Remove unnecessary columns
    df = df.drop(columns=['quantity_footnotes', 'category', 'unit', 'quantity', 'commodity_transaction'])

    # Pivot the dataframe to have years as columns
    df_years = df.pivot(index='country_or_area', columns='Year')

    # Pivot the dataframe to have countries as columns
    df_countries = df.pivot(index='Year', columns='country_or_area')
...
df_years = df.pivot_table(index='country_or_area', columns='Year', aggfunc='first')
# Create a dataframe with countries as columns
df_countries = df.pivot_table(index='Year', columns='country_or_area', aggfunc='first')


# In[ ]:


# Function for describing file data:
df.describe()
...
# Function for checking shape of file :
df.shape
...
# Function for droping value from file:
...
#I create a new data frame with are all the countries related to Wind Production,
# also I create with 5 countries of the "European Union". 
#Is important to understand that I’m not trying to represent the whole EU, 
...
#In this section I create a new data frame with are all the countries related to Solar Production,
# also I create with 5 countries the "European Union".
 #Is important to understand that I’m not trying to represent the hole EU.
...
#In this section I create a new data frame with are all the countries related to Nuclear Production,
# also I create with 5 countries the "European Union". Is important to understand 
#that I’m not trying to represent the hole EU.
